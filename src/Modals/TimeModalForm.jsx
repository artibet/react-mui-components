...
import { MyTimeField } from '../form-fields'
import { EditNoteRounded } from '@mui/icons-material'

export const TimeModalForm = ({
  open,
  title,
  label,
  value,
  ...
  const schema = yup.object({
    datetime: required
      ? yup
        .date()
        .typeError('Μη έγκυρη μορφή ώρας')
  ...
  return (
    ...
    >
      ...
      <form onSubmit={form.handleSubmit(data => onSubmit(data.datetime))} noValidate>
        <DialogContent>
